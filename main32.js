...
const current_Users = ['Tayyaba', 'Fatima', 'Malaika', 'Ayma', 'Shams', 'Pakiza', 'tahira'];
const new_Users = ['Chandni', 'tayyaba', 'sunaira', 'Ayma', 'malaika', 'farah', 'roshni'];
const currentuserL = current_Users.map(user => user.toLowerCase());
